...
export const NEON_OBSTACLES = Object.freeze([
  {
    key: 'neon-control-box',
    label: '失控配电箱',
    width: 74,
    height: 58,
    action: 'jump',
    body: { width: 62, height: 46, offsetX: 6, offsetY: 12 },
  },
  {
    key: 'neon-turret',
    label: '警戒炮塔',
    ...
    height: 62,
    action: 'jump',
    body: { width: 54, height: 52, offsetX: 6, offsetY: 10 },
  },
  {
    key: 'neon-hover-car',
    label: '横穿浮空车',
    ...
    height: 70,
    action: 'jump',
    body: { width: 100, height: 50, offsetX: 6, offsetY: 16 },
  },
  {
    key: 'neon-reactor',
    label: '超高反应堆',
    ...
    height: 158,
    action: 'doubleJump',
    body: { width: 82, height: 150, offsetX: 7, offsetY: 8 },
  },
  {
    key: 'neon-energy-orb',
    label: '漂移数据球',
    ...
    placement: 'air',
    y: 399,
    body: { width: 38, height: 34, offsetX: 13, offsetY: 5 },
  },
  {
    key: 'neon-drone',
    label: '低空扫描机',
